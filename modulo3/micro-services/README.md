...
curl -X POST -H 'Content-Type:application/json' curl $REST_IP:8080/criaRestaurante --data '{"nome":"r2", "morada":"m1", "codigoPostal":"8990-899"}'


#CRIAR/MENU
curl -X POST -H 'Content-Type: application/json' curl $REST_IP:8080/criaMenu/Entradas --data '{"nome":"Menu","descricao":" ...","opcaoMenu":[{"arroz":"arroz de pato", "feijao":"feijao preto"}]}'

#ENCOMENDAS
curl -X POST -H 'Content-Type: application/json' curl $REST_IP:8080/criaEncomenda/Entradas --data '["Menu "]'
